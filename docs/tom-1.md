...
- [1. Product Overview (Общие сведения)](#1-product-overview-общие-сведения)
  - [1.1 Purpose & Scope](#11-purpose--scope)
    - [1.1.2 Текущее состояние системы (AS IS)](#112-текущее-состояние-системы-as-is)
    - [1.1.3 География покрытия](#113-география-покрытия)
    - [1.1.4 User Personas (Пользовательские роли)](#114-user-personas-пользовательские-роли)
  - [1.2 Glossary (Глоссарий)](#12-glossary-глоссарий)
  - [1.3 Non-Functional Requirements (NFR)](#13-non-functional-requirements-nfr)
    - [1.3.1 Frontend Performance Budget](#131-frontend-performance-budget)
  - [1.4 External Integrations (Внешние интеграции)](#14-external-integrations-внешние-интеграции)
  - [1.5 Error Handling & Resilience (Обработка исключений)](#15-error-handling--resilience-обработка-исключений)
  - [1.6 Business Model (Бизнес-модель)](#16-business-model-бизнес-модель)
    - [1.6.1 Доходы (Revenue Streams)](#161-доходы-revenue-streams)
    - [1.6.2 Расходы (Cost Structure)](#162-расходы-cost-structure)
    - [1.6.3 Юнит-экономика](#163-юнит-экономика)
    - [1.6.4 Модель ценообразования (Pricing)](#164-модель-ценообразования-pricing)
    - [1.6.5 Ключевые метрики для дашборда](#165-ключевые-метрики-для-дашборда)
